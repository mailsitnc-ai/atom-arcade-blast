...
export const LEVELS: LevelDef[] = [
  ...
  },
  {
    ...
    weapon: { name: "Corrosive Acid Pool", color: "#39ff14", speed: 9, size: 7, damage: 2 },
    bgA: "#04231a", bgB: "#0a4a2e",
    enemyColor: "#39ff14", enemySpeed: 1.8, enemyHp: 4,
  ...
  },
  {
    ...
    weapon: { name: "Chain Lightning", color: "#ff3df0", speed: 10, size: 7, damage: 3 },
    bgA: "#22041a", bgB: "#5a0a3a",
    enemyColor: "#ff3df0", enemySpeed: 2.1, enemyHp: 4,
  ...
  },
  {
    ...
    weapon: { name: "Fusion Nova (AoE Blast)", color: "#fff176", speed: 11, size: 10, damage: 4 },
    bgA: "#2a1a04", bgB: "#5a3a0a",
    enemyColor: "#fff176", enemySpeed: 2.4, enemyHp: 5,
